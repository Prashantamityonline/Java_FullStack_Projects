            ...
            <div className="container-fluid my-3">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='bg-primary w-100 p-2 text-light text-center'>Subcategory <Link to="/admin/subcategory"><i className='fa fa-long-arrow-left text-light float-end'></i></Link></h5>
